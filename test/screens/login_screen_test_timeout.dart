/// Testes para a tela de login (versão corrigida)
/// 
...
void main() {
  ...
  group('LoginScreen Tests', () {
    ...
    Widget createLoginScreen() {
      return MaterialApp(
        home: ChangeNotifierProvider<AuthService>.value(
          ...
          child: const TestLoginScreen(), // Usa versão de teste
        ),
      );
    }
    ...
    testWidgets('should call signIn with correct credentials', (WidgetTester tester) async {
      ...
      // Aguarda o processamento sem pumpAndSettle
    ...
    testWidgets('should accept valid email formats', (WidgetTester tester) async {
      ...
      // Aguarda apenas o processamento inicial sem pumpAndSettle
